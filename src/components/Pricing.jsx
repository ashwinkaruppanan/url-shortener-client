...
const Pricing = () => {
  ...
  return (
    <div className="px-5 mt-16 sm:mt-4 lg:mt-0 sm:px-16 lg:px-20">
      <h2
        id="pricing"
        className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500 text-3xl sm:text-4xl  font-bold text-center "
      >
        Pricing
      </h2>
      ...
      <p className="text-white text-center sm:text-2xl lg:text-base mt-5 lg:mt-8 sm:mb-10 ">
        Connect to your audience with branded links and QR Codes that will get
        their attention.
      </p>
      <div className="lg:flex justify-center">
        <div className="sm:flex sm:justify-evenly sm:w-full lg:w-2/3 ">
          <div className="relative sm:w-1/2 sm:px-4 ">
            ...
            <div className=" bg-gray-100 glass-card mt-10 sm:h-[91.5%] ">
              <h2 className="text-white text-center py-4 text-2xl font-semibold sm:text-3xl lg:text-2xl">
                FREE
              </h2>
              <hr />
              <p className="text-white text-lg pl-3 mt-4 font-semibold sm:text-xl ">
                10 links with QR Codes per month
              </p>
              <ul className="text-white pl-5 leading-10 mt-4 lg:text-base lg:leading-9">
                <li>Link & QR Code redirects</li>
                <li>Custom back-half</li>
                <li>QR Codes</li>
                <li>Track Locations</li>
              </ul>
              <h2 className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 text-5xl font-extrabold text-center my-5 ">
          ...
          <div className="relative sm:w-1/2 sm:px-4 ">
            ...
            <div className=" bg-gray-100 glass-card mt-10  ">
              ...
              <ul className="text-white pl-4 leading-10 mt-4 lg:text-base lg:leading-9 ">
      ...
      <div className="mt-20 sm:mt-28 ">
        <h2 className="  text-transparent bg-clip-text bg-gradient-to-r to-purple-500 from-cyan-500 text-4xl font-bold text-center">
          More than a free link shortener
        </h2>
        <div className="flex justify-center mt-6">
          <Link to="/signup">
            <button className="  text-center text-white bg-blue-500 hover:bg-blue-600 rounded-lg text-xl font-semibold px-4 py-3">
              Get Started
            </button>
          </Link>
        </div>
