...
const Product = () => {
  ...
  return (
    <>
      <div id="product" className="px-5 mt-8 lg:mt-0 sm:px-16 lg:px-20 ">
        ...
        <div>
          ...
          <p className="text-white text-center mt-5 lg:mt-2 sm:text-2xl lg:px-72 lg:text-base">
        ...
        <div className="lg:flex xl:justify-center xl:px-80 lg:justify-center">
          <div className="sm:flex sm:justify-evenly sm:w-full lg:w-2/3  ">
            <div className="mt-12 px-4 sm:w-1/2">
              <div className="text-white border-2 border-gray-300 rounded-xl p-5">
                <div className="flex items-center w-full justify-center ">
                  ...
                  <h3 className="text-white font-semibold text-lg ml-1 sm:text-xl ">
                    Link Management
                  </h3>
                </div>
                <div className="bg-blue-500 h-0.5 rounded-xl w-full mt-2 lg:mt-5"></div>
                <div className="mt-4 text-lg sm:text-xl lg:text-base">
                ...
                <div className="mt-4">
                  <ul className="list-disc ml-4 leading-8 sm:text-xl lg:text-base">
                ...
                <Link to="/signup">
                  <button className=" sm:text-xl lg:text-base bg-blue-500 hover:bg-blue-600 rounded-lg py-2 text-center w-full mt-6 ">
            ...
            <div className="mt-12 px-4 sm:w-1/2 ">
              <div className="text-white border-2 border-gray-300 rounded-xl p-5 sm:h-full">
                ...
                <Link to="/signup">
                  <button className=" sm:text-xl  bg-blue-500 hover:bg-blue-600 rounded-lg py-2 text-center w-full mt-6 sm:mt-[3.3rem] lg:text-base lg:mt-12 ">
                    Get Started for Free
                  </button>
                </Link>
              </div>
